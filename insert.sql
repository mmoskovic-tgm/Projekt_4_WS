		...
		INSERT lebensdaten(id,nachname,vorname,gebDatum,verstorbenAm,geschwister,geschlecht,maedName) VALUES (90,"Urban","Gisella","1906","1973","52;89","weiblich","Ettl");
		...
		INSERT lebensdaten(id,nachname,vorname,gebDatum,verstorbenAm,geschwister,geschlecht,maedName) VALUES (87,"Urban","Mathilde","1944","","51;84;85;86;83;88","weiblich","Egger");
		INSERT lebensdaten(id,nachname,vorname,gebDatum,verstorbenAm,geschwister,geschlecht,maedName) VALUES (86,"Urban","Suzanne","1942","","51;84;85;83;87;88","weiblich","Renzi");
		INSERT lebensdaten(id,nachname,vorname,gebDatum,verstorbenAm,geschwister,geschlecht,maedName) VALUES (85,"Urban","Renate","1939","","51;84;83;86;87;88","weiblich","Sarnthein");
		...
		INSERT lebensdaten(id,nachname,vorname,gebDatum,verstorbenAm,geschwister,geschlecht,maedName) VALUES (83,"Urban","Monika","1935","","51;84;85;86;87;88","weiblich","Illes");
		
		
		INSERT lebensdaten(id,nachname,vorname,geschlecht,maedName) VALUES (82,"Sterneder","Aloisia","weiblich","Radlmaier");
		...
		INSERT lebensdaten(id,nachname,vorname,geschlecht,maedName) VALUES (78,"Urban","Anna","weiblich","Sedlacek");
		INSERT lebensdaten(id,nachname,vorname,geschlecht) VALUES (77,"Urban","Johann","m&#228nnlich");
		
		INSERT lebensdaten(id,nachname,vorname,geschlecht,maedName) VALUES (76,"Strassky","Mathilde","weiblich","Riedl");
		...
		INSERT lebensdaten(id,nachname,vorname,geschlecht,vater,mutter,maedName) VALUES (73,"W&#252rth","Theresia","weiblich",81,82,"Sterneder");
		INSERT lebensdaten(id,nachname,vorname,geschlecht) VALUES (72,"W&#252rth","Vinzenz","m&#228nnlich");
		
		INSERT lebensdaten(id,nachname,vorname,geschlecht,maedName) VALUES (71,"Kirchmayr","Rosalia","weiblich","Stressler");
		INSERT lebensdaten(id,nachname,vorname,geschlecht) VALUES (70,"Kirchmayr","Stefan","m&#228nnlich");
		
		INSERT lebensdaten(id,nachname,vorname,geschlecht,vater,mutter,maedName) VALUES (69,"Wolfart","Katharina","weiblich",79,80,"Tr&#228xler");
		...
		INSERT lebensdaten(id,nachname,vorname,geschlecht,vater,mutter,maedName,gebDatum) VALUES (61,"Kirchmayr","Magdalena","weiblich",72,73,"W&#252rth","1836");
		INSERT lebensdaten(id,nachname,vorname,geschlecht,vater,mutter) VALUES (60,"Kirchmayr","Stefan","m&#228nnlich",70,71);
		
		INSERT lebensdaten(id,nachname,vorname,geschlecht,vater,mutter,maedName,gebDatum) VALUES (59,"Urban","Elisabeth","weiblich",68,69,"Wolfart","1843");
		...
		INSERT lebensdaten(id,nachname,vorname,geschlecht,gebDatum,verstorbenAm,vater,mutter,maedName) VALUES (55,"Urban","Berta","weiblich","1872","1951",60,61,"Kirchmayr");
...
/*
INSERT lebensdaten(id,nachname,vorname,rufname,titel,kurzzeichen,gebDatum,gebOrt,konfession,ausbildung,berufLaufbahn,profTaetigkeiten,hobbies,vater,mutter,gebMutter,partnerin,trauDatum,trauOrt,kind,verstorbenAm,verstorbenIn,todUrsache,begraebnisAm,begraebnisIn,militaerdienst,geschlecht,stammbaum) VALUES (null,"H&#252bner","Lambert","-","Leutnant der Fliegerkompanie 26","H&#252-La","19.03.1892","Wien","r&#246m. kath.", "Studium Technische Hochschule Leoben, Ausbildung zum Pilot (1. Weltkrieg)","Fliegerleutnant, Stabsoffizier R.u.R. Fliegertruppe beim 3. Armeekommando ","-","-",100,100,"Teufert",100,"-","-","-","07.07.1917","Flugfeld Clocin","Abschuss im 1. Weltkrieg","-","-","Milit&#228rakademie (Wr. Neustadt)","m&#228nnlich",true);
...
INSERT lebensdaten(id,nachname,vorname,maedName,rufname,titel,kurzzeichen,gebDatum,gebOrt,konfession,ausbildung,berufLaufbahn,profTaetigkeiten,hobbies,vater,mutter,gebMutter,partnerin,trauDatum,trauOrt,kind,verstorbenAm,verstorbenIn,todUrsache,begraebnisAm,begraebnisIn,militaerdienst,geschlecht,stammbaum) VALUES (null,"Chrast","Maria Heurietta","Hausknost","Mitzi","-","-","08.12.1891","Ebenfurth","r&#246m.kath.", "-","-","-","-",103,103,"Schwab",103,"-","-","Heuriette Marie","-","-","-","-","Spittal an der Donau","-","weiblich",true);
#
INSERT lebensdaten(id,nachname,vorname,rufname,titel,kurzzeichen,gebDatum,gebOrt,konfession,ausbildung,berufLaufbahn,profTaetigkeiten,hobbies,vater,mutter,gebMutter,partnerin,trauDatum,trauOrt,kind,verstorbenAm,verstorbenIn,todUrsache,begraebnisAm,begraebnisIn,militaerdienst,geschlecht,stammbaum) VALUES (null,"H&#252bner","Lambert","-","Dr. med. vet.","H&#220-La II","28.06.2019","Baden","r&#246m. kath.", "Mateura (M&#246dling), Tier&#228rztliche Hochschule","Tierarzt (Privatpraxis, Tierklinik mit Kollegen, Salzburg","-","Sport, Reisen, Oper, Theater, etc.",104,104,"Schwab",104,"ca 1968 (Scheidung ca. 1984)","Salzburg","Eleonora ,Clemens","-","-","-","-","-","-","m&#228nnlich",true);

INSERT lebensdaten(id,nachname,vorname,maedName,rufname,titel,kurzzeichen,gebDatum,gebOrt,konfession,ausbildung,berufLaufbahn,profTaetigkeiten,hobbies,vater,mutter,gebMutter,partnerin,trauDatum,trauOrt,kind,verstorbenAm,verstorbenIn,todUrsache,begraebnisAm,begraebnisIn,militaerdienst,geschlecht,stammbaum) VALUES (null,"H&#252bner","Elfriede Marie","-","Friedl","Dkfm, Mag.","H&#220-Frie","11.07.1935","Baden","r&#246m. kath.", "Matura, Hochschule f&#252r Welthandel","HAK Professorin, 29 Jahre Inhaberin einer Privatschule","-","Sport, Reisen, Oper, Theater",105,105,"Schwab",105,"-","-","-","-","-","-","-","-","-","weiblich",true);

INSERT lebensdaten(id,nachname,vorname,maedName,rufname,titel,kurzzeichen,gebDatum,gebOrt,konfession,ausbildung,berufLaufbahn,profTaetigkeiten,hobbies,vater,mutter,gebMutter,partnerin,trauDatum,trauOrt,kind,verstorbenAm,verstorbenIn,todUrsache,begraebnisAm,begraebnisIn,militaerdienst,geschlecht,stammbaum) VALUES (null,"Sunk","Maria Anna","Schwab","Mimi","-","-","01.01.1906","Baden","r&#246m. kath.", "B&#252rgerschule","Bankangestellte","-","-",106,106,"Zinuber",106,"-","-","42","-","-","-","-","Klagenfurt-Virting","-","weiblich",true);
